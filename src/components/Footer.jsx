...
const API_SUBSCRIBE = "https://shopnest-serveres.onrender.com/policiesuser";
...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-white text-black">
      ...
      <div className="relative z-10 w-[1300px] mx-auto px-4 py-16">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <form onSubmit={handleSubscribeSubmit} className="space-y-4 max-w-md relative">
              ...
              <button
                ...
                className="w-full py-4 bg-[#FF6600] text-white font-bold rounded-2xl hover:bg-orange-600 hover:scale-105 transition-all duration-300"
              >
