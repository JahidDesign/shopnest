      ...
      <div className="max-w-8xl mx-auto relative z-10">
        ...
        <div className="mb-16">
          ...
          <motion.div
            ...
            className="h-1.5 bg-gradient-to-r from-[#FF6600] via-[#FFA500] to-[#FF7F32] rounded-full mt-6"
          />
        </div>
        ...
        {Array.isArray(categories) && categories.length > 0 ? (
            ...
            {categories.map((cat, index) => (
              ...
              >
                <a href={cat.link || "#"} className="block">
                  <div className="relative overflow-hidden bg-white shadow-lg transition-all duration-500 hover:shadow-2xl">
                    {/* Image Container */}
                    <div className="relative h-40 sm:h-48 md:h-56 lg:h-48 xl:h-48 overflow-hidden">
                      <motion.img
                        src={cat.image}
                        alt={cat.title}
                      ...
                      <motion.div
                        ...
                        initial={{ opacity: 0.6 }}
                        animate={{ opacity: hoveredId === cat.id ? 0.8 : 0.6 }}
                        transition={{ duration: 0.3 }}
                      />

                      {/* Hover Accent */}
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-br from-[#FF6600]/20 to-[#FFA500]/20"
                        initial={{ opacity: 0 }}
                    ...
                    <div className="relative p-4 sm:p-5">
                      <motion.h3
                        className="text-medium sm:text-xs font-bold text-[#CC5500] mb-1"
                      ...
                      >
                        ...
                        <motion.svg
                          ...
                          viewBox="0 0 24 24"
                          animate={{ x: hoveredId === cat.id ? 2 : 0 }}
                          transition={{ duration: 0.3, repeat: hoveredId === cat.id ? Infinity : 0, repeatType: "reverse" }}
                        >
                          <path
                            strokeLinecap="round"
                      ...
                      <motion.div
                        ...
                        initial={{ width: 0 }}
                        animate={{ width: hoveredId === cat.id ? "100%" : "0%" }}
                    ...
                    <motion.div
                      className="absolute top-2 right-2 w-10 h-10 border-2 border-[#FF6600] opacity-0"
                      animate={{
                        opacity: hoveredId === cat.id ? 1 : 0,
                        scale: hoveredId === cat.id ? 1 : 0.5,
                        rotate: hoveredId === cat.id ? 180 : 0,
                      }}
          ...
          >
            <div className="w-24 h-24 mb-6 bg-gradient-to-br from-[#FF6600]/20 to-[#FFA500]/20 flex items-center justify-center">
              <svg
            ...
            <p className="text-sm text-gray-400 mt-2">Check back soon for new collections</p>
          </motion.div>
        )}
      </div>
    </section>
